<ol>
	...
	<li><?php echo esc_html( __( 'When logged-in to WP dashboard you can also start the meeting as a moderator from the invite link', 'video-conferencing-with-bbb' ) ); ?></li>
</ol>
