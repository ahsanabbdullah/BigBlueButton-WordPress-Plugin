<div class="zvc-row">
				...
				<ol>
					<li>
						...
						<span class="tooltip" onclick="copyToClipboard(this)" onmouseout="copyClipboardExit(this)"
							...
							<span class="bbb-dashicon dashicons dashicons-admin-page"></span> <strong><?php esc_html_e( 'Pro Version Note', 'video-conferencing-with-bbb' ); ?></strong>
						</span>
						<div class="desc">
							<ul>
	...
	<div class="zvc-position-floater-right">
		...
		<?php if ( ! VCBBB_Loader::is_bbb_pro_active() ) : ?>
		<div class="zvc-information-sec">
...
<?php if ( ! VCBBB_Loader::is_bbb_pro_active() ) : ?>
    <div class="zvc-information-sec">
        ...
        <a rel="noopener" target="_blank" href="https://elearningevolve.com/products/video-conferencing-with-bbb-pro/">
            <button class="bbb-settings-btn">View More</button>
        </a>
        <hr />
    </div>
<?php endif; ?>
