 ...
 */
class VCBBB_Public_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array(
				...
				'description'                 => __( 'Displays a BigBlueButton login form.', 'video-conferencing-with-bbb' ),
	...
	public function widget( $args, $instance ) {
		...
		echo VCBBB_Tokens_Helper::maybe_recordings_table_for_room_tokens( $display_helper, $tokens_string, $author );
